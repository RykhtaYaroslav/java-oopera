public class Theatre {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        personManager.addMusicAuthor("Морген", "Штерн", Sex.MALE);
        personManager.addChoreographer("Алла", "Пугачёва", Sex.FEMALE);
        System.out.println();
        ...
        showManager.createNewOpera("Колобок", 50, PersonManager.getOtherPersons().get("Штерн"), "Жили старик " +
        ...
        showManager.createNewBallet("Страусиное озеро", 75, PersonManager.getOtherPersons().get("Штерн"),
                "Страусы у озера танцуют брейк-данс", PersonManager.getOtherPersons().get("Пугачёва"));
