...
public class ShowManager {
    /* Тут нигде нет проверок на существование названий представлений, актёров и т.д., так как нет консольного
    интерфейса (потому что такое ТЗ). Раз нет ввода из консоли, значит не может быть никакой ошибки и нет смысла
    в валидации вводных данных
     */
    ...
    public void createNewBallet (String title, int duration, String musicAuthor, String librettoText, String choreographer) {
    ...
    public void createNewOpera (String title, int duration, String musicAuthor, String librettoText, int choirSize) {
